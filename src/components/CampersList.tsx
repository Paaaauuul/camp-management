        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-3 px-4 font-semibold text-gray-900">Times booked</th>
              <th className="text-right py-3 px-4 font-semibold text-gray-900">Spent</th>
              <th className="text-left py-3 px-4 font-semibold text-gray-900">Last stayed</th>
                ...
                >
                  ...
                  <td className="py-3 px-4 text-gray-600">
                    {customer.last_stayed 
                      ? format(parseISO(customer.last_stayed), 'MM-dd-yyyy')
                      : '-'}
                  </td>
                  <td className="py-3 px-4">
