...
import { getSites, getBookings, getReservations, getSitePricing } from '../lib/queries';
...
export function useReservationForm({
  ...
  const [selectedSiteId, setSelectedSiteId] = useState<number | null>(() => initialData?.siteId || null);
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        const [sitesData, bookingsData, reservationsData] = await Promise.all([
          getSites(),
          getBookings(
